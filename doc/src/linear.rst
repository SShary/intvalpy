...
Визуализация решений системы неравенств
------------
...
Если дана интервальная система линейных алгебраических уравнений A x = b с двумя переменными, то для визуализации 
её множества решений методом граничных интервалов можно воспользоваться функцией ``IntLinIncR2``, которая 
также выводит вершины многогранника множества решений. 
...
Метод Хансена-Блика-Рона для переопределённых систем
------------

Процедура Хансена-Блика-Рона для переопределённых ИСЛАУ:
